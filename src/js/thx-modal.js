const callbackForm = document.querySelector('.registration-form');
const requestReceivedModal = document.querySelector('.thx-modal');
const userName = document.querySelector('#name-form');
const userEmail = document.querySelector('#email-form');
const userPhone = document.querySelector('#phone2');
